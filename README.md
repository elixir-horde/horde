...
If you continue to prefer using the CRDT-based approach, it remains fully available under the new package name **`horde-classic`** at https://hex.pm/packages/horde_classic. This provides full continuity for existing configurations while allowing new projects to benefit from the improved design.
